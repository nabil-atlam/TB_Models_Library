...
def plot_bs(
    ...
    """
    Plot the BS
    hsps: a Dict. Keys = labels e.g. K, M, Gamma etc. Values = coordinates of HSPs
    """
    hsps_labels = list(hsps.keys())
    hsps_vals = list(hsps.values())
...
hop, overlap = _hash_from_mat("ftnfile(1layer).mat", "ftn60_h", "ftn60_s")
uc = [[3.1790,0,0],[-1.5895,2.7531,0],[0,0,12.7290]]
plot_bs(hsps, hop, overlap, uc)
